...
export default function ProfileClient({
    ...
    return (<div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
        ...
        <div className="mx-auto p-6 grid grid-cols-1 md:grid-cols-4 gap-8 mt-6">
            ...
            <div className="col-span-1 md:col-span-2 space-y-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <nav className="flex space-x-8 border-b border-gray-200 pb-3 mb-6 text-sm font-bold tracking-wider">
                        {["ABOUT", "PUBLICATIONS", "GRANTS", "NETWORK"].map(
                            (tab) => (
                                <button
                                    key={tab}
                                    type="button"
                                    ...
                                    className={`pb-2 transition ${activeTab === tab
                                            ? "text-(--arcand-primary) border-b-4 border-(--arcand-accent)"
            ...
            {/* Right Profile / Collaboration Info */}
                            ...
                            {sharedWorks.length > 0 ? (
                                <ul className="space-y-3">
                                    {sharedWorks.map((work, idx) => (
                                        <li
                                            key={idx}
                                            className="text-sm text-gray-700 bg-gray-50 p-3 rounded-lg border border-gray-100"
                                        >
                                ...
                                <p className="text-sm text-gray-500 italic">
                                    No direct shared works found with{" "}
                                    {member.name}.
                                </p>
                            )}
